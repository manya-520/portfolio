...
export const ADRS = [
  ...
  },
  {
    ...
    title: "Adopt route-level code splitting for heaviest admin bundles",
    suggestedBy: "Decisions Agent",
    suggestedAt: "2 days ago",
    updatedAt: "5h ago",
    repo: "actual-software/web-platform",
    ...
    primaryAction: "Approve & Sync",
    href: "/work/actual/adr/web-platform",
    activeDaysLabel: "Active for 9 days",
    scopePaths: ["apps/admin/**/*", "packages/bundler/**/*"],
    sections: [
      {
        title: "Context",
        body: "Largest admin routes ship monolithic chunks; first paint regressed after the last release train.",
      },
      {
        title: "Decision",
        body: "Heavy admin routes load via dynamic import with a shared skeleton; critical path stays under 200KB gzip.",
      },
      {
        title: "Consequences",
        body: "+ Faster initial load\n+ Clearer ownership per route\n− Requires bundle budget CI",
      },
    ],
    timeline: TIMELINE_PROGRESS,
    agents: AGENTS_DEFAULT,
  },
  {
    ...
    title: "Circuit-break outbound webhooks at the worker boundary",
    suggestedBy: "Decisions Agent",
    suggestedAt: "4 days ago",
    updatedAt: "1d ago",
    repo: "actual-software/agents-runtime",
    ...
    primaryAction: "View in repo",
    href: "/work/actual/adr/agents-runtime",
    activeDaysLabel: "Active for 7 days",
    scopePaths: ["workers/webhooks/**/*", "packages/resilience/**/*"],
    sections: [
      {
        title: "Context",
        body: "Partner spikes caused cascading retries that saturated the shared HTTP pool twice last month.",
      },
      {
        title: "Decision",
        body: "Outbound webhooks use a sliding-window breaker with jittered backoff; breaches surface as DLQ tasks.",
      },
      {
        title: "Consequences",
        body: "+ Protects shared capacity\n+ Predictable operator signals\n− Tuning per partner tier",
      },
    ],
    timeline: TIMELINE_REVIEWED,
    agents: AGENTS_DEFAULT,
  },
  {
    id: "0214-05",
    category: "Observability",
    title: "Standardize RED metrics on all gRPC services",
    suggestedBy: "Decisions Agent",
    suggestedAt: "6 days ago",
    updatedAt: "2d ago",
    repo: "actual-software/on-prem",
    ...
    primaryAction: "Continue draft",
    href: "/work/actual/adr/on-prem",
    activeDaysLabel: "Active for 5 days",
    scopePaths: ["services/**/*", "observability/grpc/**/*"],
    sections: [
      {
        title: "Context",
        body: "Dashboards mix HTTP and gRPC signals; on-call cannot compare error budgets across services.",
      },
      {
        title: "Decision",
        body: "Every gRPC server exports rate, errors, and duration histograms with consistent label sets.",
      },
      {
        title: "Consequences",
        body: "+ Comparable SLOs\n+ Faster triage\n− Migration for legacy interceptors",
      },
    ],
    timeline: TIMELINE_DRAFT,
    agents: AGENTS_DEFAULT,
